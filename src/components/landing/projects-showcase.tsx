            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span className="absolute left-5 top-5 font-mono text-[11px] font-medium tracking-widest text-white/50">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <div className="absolute right-5 top-5 flex size-10 items-center justify-center rounded-xl border border-white/10 bg-black/30 text-white/60 backdrop-blur-md transition-colors group-hover:border-white/20 group-hover:text-white/90">
